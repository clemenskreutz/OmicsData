...
%         % Remember best methods to repeat for hyperparameters
%         if exist('method_rem','var')
%            method_rem = unique([method_rem,method(1:3)]);
%         else
%             method_rem = method(1:3);
%         end
%         if b==size(dat_mis_ges,3)
%             O = set(O,'method_imput_rem',method_rem);
%         end
